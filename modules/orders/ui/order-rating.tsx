...
//   productId,
// }: props) => {
//   const [allRating, setAllRating] = useState<ratingProps[]>([]);
...
//       {(allRating?.[orderIndex]?.id === undefined &&
//         allRating?.[orderIndex]?.id !== ratingId) ? (
//           <>
...
//               ${
//                 (allRating?.[orderIndex]?.rating) >= star ? "text-[#FFA534]" : "text-[#e7e5e4]"
//               }`}
//                   fill={(allRating?.[orderIndex]?.rating) >= star ? "#FFA534" : "#e7e5e4"}
//                 />
//               ))}
//             </div>
//           </>
